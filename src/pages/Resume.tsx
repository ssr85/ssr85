            ...
            <div className="w-[35%] bg-[#5D2E2E] text-white p-6 print:p-5 flex flex-col">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="font-semibold">Master of Business Administration</p>
        ...
        <div className="resume-page bg-white shadow-lg print:shadow-none mx-auto overflow-hidden">
          <div className="flex h-full">
            ...
            <div className="w-[35%] bg-[#5D2E2E] text-white p-6 print:p-5 flex flex-col">
              ...
              {/* Tools & Technologies */}
              <div className="mb-6">
                <h3 className="text-xs uppercase tracking-widest mb-3 border-b border-white/30 pb-2">Tools & Technologies</h3>
                <ul className="space-y-1 text-sm">
