...
const iconMap: Record<string, { icon: React.ReactNode; color: string }> = {
  ...
  BookOpen: { icon: <BookOpen className="h-6 w-6" />, color: "bg-primary/15 text-primary" },
  Dumbbell: { icon: <Dumbbell className="h-6 w-6" />, color: "bg-secondary/15 text-secondary" },
  GraduationCap: { icon: <GraduationCap className="h-6 w-6" />, color: "bg-accent/15 text-accent" },
};

export const BeyondWork = () => {
  return (
    <section id="beyond-work" className="py-12 md:py-16 px-4 bg-muted/30">
